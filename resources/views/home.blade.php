...
<head>
    ...
    <style>
        .btn-custom {
            ...
            /* Color de fondo similar al proporcionado */
            color: #000;
            ...
            /* Centrar el texto */
            margin-bottom: 20px;
            /* Espacio entre los botones y los campos de abajo */
            height: 50px;
        ...
        .btn-wide {
            width: 320px;
            /* Ancho mayor para el botón de "HOTEL + TRANSPORTE" */
        }
        ...
        .btn-custom:focus {
            ...
            /* Color más oscuro en hover/focus */
            color: #000;
            /* Asegurarse de que el texto permanezca negro */
        }
        ...
        .mb-4 {
            margin-bottom: 30px;
            /* Espacio entre los botones y los campos de reserva */
        }
    </style>
...
<body>
    ...
    <div class="container header-content mt-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center text-md-start">
                ...
                <a href="{{ route('servicios') }}" class="btn btn-descubre">DESCÚBRELO</a>
            </div>
    ...
    <div class="container my-5">
        ...
        <form action="{{ route('buscar') }}" method="POST">
            ...
            <div class="row text-center justify-content-center">
                <div class="col-md-2 mb-3">
                    <input type="text" name="ciudad_origen" class="form-control" placeholder="CIUDAD DE ORIGEN"
                        required>
                </div>
                <div class="col-md-2 mb-3">
                ...
                <div class="col-md-2 mb-3">
                    <input type="number" name="numero_personas" class="form-control" placeholder="Número de personas"
                        required>
                </div>
            </div>
        ...
        <style>
            ...
            .carousel-inner img {
                max-width: 100%;
                /* Ajusta el ancho máximo de la imagen dentro del carrusel */
                max-height: 350px;
                /* Ajusta la altura máxima de la imagen dentro del carrusel */
                object-fit: cover;
                /* Asegura que la imagen se ajuste dentro del carrusel sin distorsión */
            }
        </style>
